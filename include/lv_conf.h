 ...
 *
 * Migrated from a v8.3.6 configuration.
 */
...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_DRAW_SW_SUPPORT_RGB565_SWAPPED       1 /* Enabled for flexibility, v8's LV_COLOR_16_SWAP is now a driver property */
...
#define LV_CACHE_DEF_SIZE       (620 * 1024U)
...
#define LV_USE_SCALE      1   /* Migrated from LV_USE_METER in v8 */
...
#define LV_USE_THEME_SIMPLE 1 /* Migrated from LV_USE_THEME_BASIC in v8 */
...
#define LV_USE_TJPGD 0 /* Migrated from LV_USE_SJPG in v8 */
...
#define LV_USE_FREETYPE 0
    ...
    #define LV_FREETYPE_CACHE_FT_GLYPH_CNT 256 /* Migrated from LV_FREETYPE_CACHE_SIZE, value is an estimate */
#endif
...
#define LV_USE_OBSERVER 1 /* Migrated from LV_USE_MSG in v8 */
...
/* All devices disabled as per v8 config */
#define LV_USE_SDL              0
#define LV_USE_X11              0
